...
* In this lab, you'll enable the database engine and rotate its root credentials.
...
* This challenge has them enable the Database secrets engine on the path "lob_a/workshop/database database" and rotate the root credentials for it.
